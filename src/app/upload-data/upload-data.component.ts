...
export class UploadDataComponent implements OnInit {
  ...
  url = Constants.sampleEmployeeFilePath;
  title = 'Upload';
  ...
  downloadSampleFile(): void {
    ...
    link.href = Constants.sampleEmployeeFilePath;
    link.download = 'EmployeeUploadTemplate.csv';
  ...
  save(): void {
    if (this.files.length > 0 && this.tenantId.value !== undefined && this.tenantId.value !== null) {
      this.isBusy = true;
      this.userService.uploadEmployees(this.tenantId.value, this.files[0]).subscribe((event: any) => {
